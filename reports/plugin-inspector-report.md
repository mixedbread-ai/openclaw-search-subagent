...
| ------------------------ | -------- | ------------ | ----- | ---------------------------------------------------------------------------------------------------------------- | ------------------ |
| openclaw-search-subagent | high     | dynamic-tool | -     | definePluginEntry, registerAutoEnableProbe, registerCli, registerConfigMigration, registerProvider, registerTool | tools              |
...
| ------------------------ | ----------------------- | ----- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| openclaw-search-subagent | seam-inventory          | log   | observed 0 hooks, 6 registrations, and 1 manifest contracts                           | registration:definePluginEntry, registration:registerAutoEnableProbe, registration:registerCli, registration:registerConfigMigration, registration:registerProvider, registration:registerTool, manifestContract:tools | -             |
| openclaw-search-subagent | hook-names-present      | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                                                                                                                                                                                      | -             |
| openclaw-search-subagent | api-registrars-present  | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | registerAutoEnableProbe, registerCli, registerConfigMigration, registerProvider, registerTool                                                                                                                          | -             |
| openclaw-search-subagent | sdk-exports-present     | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/plugin-entry, openclaw/plugin-sdk/provider-auth-api-key, openclaw/plugin-sdk/provider-catalog-shared                                                                                               | -             |
| openclaw-search-subagent | manifest-fields-checked | log   | plugin manifest fields were compared with target OpenClaw manifest types              | openclaw.plugin.json                                                                                                                                                                                                   | -             |
| openclaw-search-subagent | package-metadata        | log   | selected package metadata for plugin contract checks                                  | package.json, @mixedbread/openclaw-search-subagent, version:0.1.0                                                                                                                                                      | -             |
| openclaw-search-subagent | declarative-contracts   | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                                                                                                                                                                  | -             |
